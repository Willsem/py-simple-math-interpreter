...
class Parser:
    ...
    def bool_expr(self):
        ...
        while self.current_token != None and self.current_token.type in (
                ...
                TokenType.LESSEQUAL,
                TokenType.EQUAL):
            if self.current_token.type == TokenType.MORE:
                self.advance()
                result = MoreNode(result, self.expr())
            elif self.current_token.type == TokenType.MOREEQUAL:
                self.advance()
                result = MoreEqualNode(result, self.expr())
                ...
                self.advance()
                result = LessEqualNode(result, self.expr())
